...
def all_population_statistic():
    height, weight, total_exercises, exercises_list = population_statictics_db_implementation.get_population_statistic()
    return render_template('tropx/statistic/index.html', height=height,
                           weight=weight, total_exercises=total_exercises,
